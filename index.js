...
bars.onclick = function() {
    ...
    document.getElementsByClassName("bars")[0].style.display = "grid";
    ...
    document.getElementsByClassName("bars")[0].style.width = "250px";
    document.getElementsByClassName("bars")[0].style.transition = "0.7s";
    document.getElementById("a2").style.display = "block"
    document.getElementById("a3").style.display = "block"
    document.getElementById("a4").style.display = "block"
}
var close = document.getElementsByClassName("fa-close")[0];

close.onclick = function() {

    document.getElementsByClassName("bars")[0].style.width = "0";
    document.getElementsByClassName("fa-bars")[0].style.display = "block"
    document.getElementsByClassName("fa-close")[0].style.display = "none"
